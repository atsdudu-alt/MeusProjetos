          ...
          >
            ...
            <div className="absolute top-6 right-6 sm:top-10 sm:right-10 z-50">
              <a
                ...
                className="flex items-center gap-2 text-sm font-medium text-slate-400 hover:text-brand-300 transition-all duration-300 border border-transparent hover:border-slate-700 bg-transparent hover:bg-slate-900/50 px-4 py-2 rounded-full cursor-pointer"
              >
                <FileText size={16} />
                <span>Currículo</span>
              </a>
            ...
            <header className="mb-16 md:mb-24 flex flex-col items-center text-center">
              ...
              >
                ...
                <span className="text-sm font-medium text-slate-300">Estudante de Engenharia de Software</span>
              </motion.div>
              ...
              <p className="text-lg sm:text-xl text-slate-400 max-w-2xl mx-auto leading-relaxed">
                Iniciei minha faculdade de Engenharia de Software no ano passado. Aqui compartilho meus projetos universitários, experimentos e o que estou construindo enquanto aprendo a programar.
              </p>
            </header>
